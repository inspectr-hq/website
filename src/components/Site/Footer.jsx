  ...
  return (
    <footer className="bg-black border-t border-gray-800 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.2fr_1fr_0.6fr_0.4fr] gap-y-10 gap-x-14">
          <div>
            ...
            <p className="text-gray-400">Simplifying API, MCP and Webhook debugging for developers.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="https://discord.gg/AA5nRgwngs"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="hover:text-brand-primary">
                  Discord
