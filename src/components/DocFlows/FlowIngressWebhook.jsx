...
import clientIcon from '../../assets/icons/webhook.svg?react';
...
export default function FlowIngressStripe() {
  const nodes = [
    // ─────── Group Nodes ───────
    {
      id: 'group_public',
      type: 'group',
      data: { label: 'wehhooks.in-spectr.dev' },
      position: { x: 300, y: 5 },
    ...
    // ─────── Regular Nodes ───────
    {
      id: '0',
      type: 'proxy',
      data: { label: 'Remote System', icon: clientIcon, showLeft: false, width: 160 },
      position: { x: 0, y: 30 }
    }, {
      id: '1',
      type: 'proxy',
