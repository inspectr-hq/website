...
:::tip
Managing multiple MCP servers? [Claude MCP Switch](/docs/guides/claude-mcp-switch/) is a macOS menu bar app that lets you toggle servers on/off and edit their config without touching JSON.
:::
