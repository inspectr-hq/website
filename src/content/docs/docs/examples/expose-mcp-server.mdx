...
or if you are looking for an example MCP server, you can use he [Everything MCP server](https://github.com/modelcontextprotocol/servers/tree/main/src/everything).
