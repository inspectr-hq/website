...
[FastMCP](https://gofastmcp.com) is powerfull Python framework to build [Model Context Protocol(MCP)](https://modelcontextprotocol.io/docs/learn/server-concepts) servers. Write simple Python functions with decorators, and FastMCP handles the protocol complexity.
