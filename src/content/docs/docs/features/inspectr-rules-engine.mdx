...
- `source_path` points to a value in the operation (headers, body, response, etc.).
...
### Rule Example - Response body user id
...
### Rule Example - JWT subject match
...
### Rule Example - Login POST endpoint
...
### Rule Example - JWT session trace
...
### Rule Example - Base64 JWT token id
