...
import tunnelExposeSettings from '../../../../assets/features/tunnel/settings-tunnel-expose.png';
...
<Image src={tunnelExposeSettings} alt="Inspectr App Expose settings showing tunnel status, local URL, public URL, channel, and channel code" />
