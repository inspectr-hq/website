...
<Aside type="note" title="Feature" icon="rocket">
  ...
  The MCP Insight view shows specific info about tools,resources,prompts usage, including token count.
</Aside>
...
- Connect with LLMs like [ChatGPT](/docs/examples/expose-mcp-server-openai/), [Claude](/docs/examples/expose-mcp-server/), or any MCP client to connect to your MCP server.
...
- [Build your own MCP server using FastMCP](/docs/examples/expose-your-fastmcp/) and connect to it with Inspectr.

<a
  href="/mcp-insights/"
  class="mt-8 inline-flex items-center justify-center rounded-xl border border-gray-800 px-4 py-2 text-sm font-semibold text-brand-primary transition-colors hover:border-brand-primary hover:text-brand-secondary"
>
