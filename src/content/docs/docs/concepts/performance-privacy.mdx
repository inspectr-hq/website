...
For the complete service boundary, see [Data Privacy & Zero Retention](/data-privacy/). The page explains the Inspectr Ingress architecture and its retention boundaries.

This local-only approach means there are no hidden backends or centralized data stores. Your environment remains under your control.
