...
---
title: MCP Server Evals with MCPJam
description: Use MCPJam with Inspectr to get run MCP evals for better visibility into your MCP servers.
---
import RelatedLink from '../../../../components/RelatedLink.jsx';
import { FlowBase } from '../../../../components/DocFlows/FlowMcpJam.jsx';
...
As [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) become the backbone for agent tooling, prompts, and resources, testing them is no longer a simple unit-testing exercise.
...
**“Do LLMs use my MCP server as expected?”**
...
```bash
# Install globally to get the `mcpjam` command
...
For deeper context, see the [MCPJam evals overview](https://docs.mcpjam.com/evals/overview) and the [evals CLI starter repo](https://github.com/MCPJam/evals-cli-starter).
...
•	MCPJam is launched by Inspectr using --command and --command-arg
•	all MCP traffic is captured and traced
