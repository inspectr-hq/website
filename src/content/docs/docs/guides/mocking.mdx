...
You can provide the OpenAPI documents as a **local file** or as a **public URL**.
...
You can also launch an OpenAPI Mock using Inspectr, by just using the URL https://inspectr.dev/launch which a reference to a remote OpenAPI document:
